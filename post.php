...
$active = 'post';
$pageTitle = 'Разместить объявление — ' . APP_NAME;
require __DIR__ . '/includes/header.php';
?>
    <section class="hero">
        <h1>Разместить объявление</h1>
        <p>Дайте старым детским вещам вторую жизнь. Добавьте фото — объявления с фото находят чаще.</p>
    </section>
    ...
    <form class="form-card" method="post" action="post.php" enctype="multipart/form-data">
